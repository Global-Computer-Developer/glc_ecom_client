                                ...
                                >
                                    <div className="content">
                                        ...
                                        <div className="cart-footer">
                                            ...
                                            <div className="actions">
                                                <Link to="/cart" className="secondary-btn" onClick={() => {setShowCart(false)}}>View Cart</Link>
                                                <Link to="/checkout" className="primary-btn" onClick={() => {setShowCart(false)}}>Checkout</Link>
                                            </div>
                                        </div>
