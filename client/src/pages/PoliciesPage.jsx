                      ...
                      <ul>
                        ...
                        <li>
                          <p>
                            ...
                            refers to Global Computer (BD), S.S.K. Road, Feni-3900.
                          </p>
                        </li>
                        <li>
                          <p>
                        ...
                        <li>
                          <p>
                            <strong>Website</strong> refers to Global Computer (BD), accessible from <Link to={`/`}>globalcomputer.com.bd</Link>
                          </p>
                        </li>
                        <li>
                          <p>
                  ...
                  <article>
                    ...
                    <p>
                      If you have any questions about this Privacy Policy, You can contact us: <br />
                        By visiting this page on our website: <Link to={`${import.meta.env.VITE_API_URL}/contact`}>Contact us</Link>
                    </p>
                  </article>
                </section>
            </div>
