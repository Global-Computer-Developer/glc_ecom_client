    ...
    <section className='policies-page'>
        <div className="container">
            <div className="wrapper">
                ...
                <section className='policies__content'>
                    ...
                    <p>
                      ...
                      <ul>
                        ...
                        <li>
                          ...
                          refers to Global Computer (BD), S.S.K. Road, Feni-3900.</p>
                        </li>
                        <li>
                        ...
                        <li>
                          ...
                          on behalf of the Company. It refers to third-party companies or individuals employed by the Company 
                        ...
                        <li>
                          ...
                          of the Service or from the Service infrastructure itself (for example, the duration of a page visit).</p>
                        </li>
                        <li>
                        <p><strong>Website</strong> refers to Global Computer (BD), accessible from <Link to={`/`}>globalcomputer.com.bd</Link></p>
                        </li>
                        <li>
                  ...
                  <article>
                    ...
                    <section>
                      ...
                      of mobile Internet browser You use, unique device identifiers and other diagnostic data. <br />
                    ...
                    <section>
                      ...
                      <ul>
                        <li>
                          ...
                          You may not be able to use some parts of our Service. Unless you have adjusted Your browser setting so that 
                      ...
                      <p>
                        ...
                        when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies
                         on the Privacy Policies website article. <br />
                  ...
                  <article>
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        of the purchase contract for the products, items or services You have purchased or of any other contract 
                  ...
                  <article>
                    ...
                    <p>
                      ...
                      if you have one, and visiting the account settings section that allows you to manage Your personal 
                      information. You may also contact Us to request access to, correct, or delete any personal information 
                      that You have provided to Us. <br />
                  ...
                  <article>
                    ...
                    <p>
                      ...
                      update the "Last updated" date at the top of this Privacy Policy. <br />
                  ...
                  <article>
                    ...
                    <p>
                      If you have any questions about this Privacy Policy, You can contact us: <br />
                        By visiting this page on our website: <Link to={`http://134.209.97.214/contact`}>Contact us</Link>
                    </p>
                  </article>
                </section>
            </div>
